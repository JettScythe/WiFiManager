...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Saving Credentials<br/>Trying to connect ESP to network.<br />Please go to CoinToys.fun to register a user account<br />If it fails reconnect to AP to try again</div>";
